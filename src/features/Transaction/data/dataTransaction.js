...
export const theadTopic = ["email", "traded", "description", "createDate", "updateDate", "status"]

export const typeTransaction = [
  { value: "", label: "All" },
  { value: "positive", label: "Positive Transaction" },
  { value: "negative", label: "Negative Transactions" }
]
