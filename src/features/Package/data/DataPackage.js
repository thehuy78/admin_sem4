...
export const ListPackagePage = styled.div`
width: 100%;
display: flex;
...
export const headerjson = ["code hospital", "name hospital", "code", "name", "fee", "description", "createDate", "updateDate", "last edit", "status"]
